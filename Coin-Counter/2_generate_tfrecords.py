...
def createTfExample(singleFileData, path):
    ...
    if pilImage.mode != 'RGB':
        print('image mode : '+pilImage.mode)
        return -1
...
def classAsTextToClassAsInt(classAsText):
    ...
    if classAsText == 'won':
        return 1
    elif classAsText == 'yen':
        return 1
    elif classAsText == 'euro_1':
        return 1
    elif classAsText == 'euro_cent_1':
        return 1
    elif classAsText == 'dollar_cent_1':
        return 1
    elif classAsText == 'koruna':
        return 1
    elif classAsText == 'ruble':
        return 1
    else:
